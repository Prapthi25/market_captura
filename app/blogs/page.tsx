      ...
      <div className="bpModal" style={{
        ...
        <div style={{ padding: '28px 32px 48px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', marginBottom: 16 }}>
            <span style={{
              background: cs.bg, color: cs.text, borderRadius: 20, padding: '3px 12px',
              fontSize: '.72rem', fontWeight: 700, letterSpacing: '.04em'
            }}>{blog.category}</span>
            {blog.featured && <span style={{
...
function BlogCard({ blog, onClick, index }: { blog: Blog; onClick: () => void; index: number }) {
  ...
  return (
    ...
    >
      {/* Cover */}
      <div style={{
        height: 210, background: 'linear-gradient(135deg,#EEF3FC,#dce6fa)',
        ...
        {blog.coverImage ? (
          ...
          <div style={{
            ...
            justifyContent: 'center', fontSize: 52, opacity: 0.25
          }}>📝</div>
        )}
        <div style={{
      ...
      <div style={{ padding: '22px 24px 24px' }}>
        ...
        <p style={{
          fontSize: '.84rem', color: '#6B7280', lineHeight: 1.65, marginBottom: 18,
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{
            fontSize: '.75rem', color: hovered ? '#2352FF' : '#9AA5B4',
...
function FeaturedCard({ blog, onClick }: { blog: Blog; onClick: () => void }) {
  ...
  return (
    ...
    >
      {/* Cover */}
      <div style={{
        height: 340, background: 'linear-gradient(135deg,#EEF3FC,#dce6fa)',
        ...
        {blog.coverImage ? (
          ...
          <div style={{
            width: '100%', height: '100%', display: 'flex', alignItems: 'center',
            justifyContent: 'center', fontSize: 72, opacity: 0.2
          }}>📝</div>
        )}
        <div style={{
          position: 'absolute', inset: 0,
        ...
        <div style={{ position: 'absolute', top: 20, left: 20, display: 'flex', gap: 8 }}>
          <span style={{
            background: cs.bg, color: cs.text, borderRadius: 20, padding: '5px 14px',
            fontSize: '.72rem', fontWeight: 700, boxShadow: '0 2px 8px rgba(0,0,0,0.08)'
          }}>
            {blog.category}
          </span>
          <span style={{
            background: '#FFF7E6', color: '#D97706', borderRadius: 20, padding: '5px 14px',
            fontSize: '.72rem', fontWeight: 700, boxShadow: '0 2px 8px rgba(0,0,0,0.08)'
          }}>
            ⭐ Featured
          </span>
